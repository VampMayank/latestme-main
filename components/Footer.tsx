    ...
    <footer style={{ position: "relative", zIndex: 1, background: "#161618", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
      ...
      <div className="footer-cta" style={{ maxWidth: 900, margin: "0 auto", padding: "56px 48px 52px", textAlign: "center" }}>
        <h2 style={{ fontSize: "clamp(26px, 4vw, 44px)", fontWeight: 900, letterSpacing: "-0.04em", color: "#E8E6F0", marginBottom: 10, lineHeight: 1.1 }}>
          ...
          <span style={{ background: "linear-gradient(90deg, #06B6D4 0%, #0EA5E9 50%, #67E8F9 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
            that matters.
          </span>
        </h2>
      ...
      <div className="footer-bar" style={{ maxWidth: 900, margin: "0 auto", padding: "22px 48px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 20, flexWrap: "wrap" }}>
        ...
        {/* Left — brand */}
        <span style={{ fontSize: 15, fontWeight: 900, color: "#E8E6F0", letterSpacing: "0.12em" }}>MV</span>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.04)", padding: "12px 48px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <p style={{ fontSize: 12, color: "#6B6585", fontWeight: 500 }}>© {new Date().getFullYear()} Mayank Verma</p>
        <button onClick={scrollTop}
          style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 11, fontWeight: 600, color: "#06B6D4", background: "rgba(6,182,212,0.08)", border: "1px solid rgba(6,182,212,0.2)", borderRadius: 7, padding: "5px 12px", cursor: "pointer", transition: "background 0.15s, border-color 0.15s, transform 0.15s" }}
          onMouseEnter={e => { const el = e.currentTarget as HTMLButtonElement; el.style.background = "rgba(6,182,212,0.16)"; el.style.borderColor = "rgba(6,182,212,0.4)"; el.style.transform = "translateY(-1px)"; }}
          onMouseLeave={e => { const el = e.currentTarget as HTMLButtonElement; el.style.background = "rgba(6,182,212,0.08)"; el.style.borderColor = "rgba(6,182,212,0.2)"; el.style.transform = "translateY(0)"; }}
        >
